document.addEventListener("DOMContentLoaded", function () {
  const projects = [
    ...
    {
      title: "Aguante la Música - Mangi ft DirJones",
      description:
        "Producción completa del tema. Creación de ritmo urbano con elementos clásicos de la costa este de USA. Mezcla con énfasis en graves definidos y claridad vocal. Mastering para plataformas digitales.",
      tags: ["Producción Completa", "Mastering", "Mezcla"],
      mediaType: "spotify",
      mediaUrl:
    ...
    },
    {
      ...
      tags: ["Grabación", "Teclados", "En Vivo"],
      mediaType: "youtube",
